...
import BessCalculator from '@/components/calculateurs/BessCalculator'

export const metadata: Metadata = { title: 'Calculateur BESS' }
  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-xl font-semibold text-navy-900">☀️ BESS Calculator</h1>
      </div>
      <BessCalculator clients={clients??[]} projects={projects??[]} quotations={quotations??[]}/>
    </div>
  )
}
