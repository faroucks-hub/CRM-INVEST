...
import FrequencyConverterCalculator from '@/components/calculateurs/FrequencyConverterCalculator'

export const metadata: Metadata = { title: 'Calculateur Frequency Converter' }

export default async function FrequencyConverterPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl">
      <div className="mb-6 flex items-center gap-3">
        ...
        <h1 className="text-xl font-semibold text-navy-900">🔄 Frequency Converter Calculator</h1>
      </div>
      <FrequencyConverterCalculator
        clients={clients ?? []}
        projects={projects ?? []}
